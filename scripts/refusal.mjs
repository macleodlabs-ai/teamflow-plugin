...
export const REFUSAL_REASONS = Object.assign(Object.create(null), {
  ...
  // MACLEOD-755: live with the free trial only. While payments are off the
  // service never ends a trial, and refuses every payment with this code.
  // The owner's sentence, with somewhere to ask.
  payments_off: 'Paid plans open soon. Your trial keeps going until then. Questions: macleod@macleodlabs.ai',
