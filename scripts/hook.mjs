...
await failOpen(async () => {
  ...
  const { state, justBound, event, project, signedIn, refused } = await handleEvent(input);
  const output = claudeContext(event, state, justBound, undefined, project, signedIn, refused);
